...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .field-input.error {
    ...
    background: #fff8f8;
    box-shadow: 0 0 0 4px rgba(224,90,90,0.1) !important;
    animation: shake 0.35s cubic-bezier(.22,1,.36,1);
  }
  @keyframes shake {
  ...
  .field-input:not(:placeholder-shown):not(:focus):not(.error) {
    border-color: #7BB8E8;
    background: #ffffff;
  }
  ...
  .toast.hide {
    animation: toastOut 0.3s cubic-bezier(.22,1,.36,1) forwards;
  }
  .toast.error {
    background: #fff2f2;
    color: #c0392b;
...
export default function SijarLogin() {
  ...
  const [errors, setErrors] = useState({ kode: false, password: false });
  ...
  const handleSubmit = () => {
    ...
    if (newErrors.kode || newErrors.password) {
      showToast('⚠️ Harap isi Kode Kelas dan Password!', 'error');
      return;
    }
    ...
    setTimeout(() => {
      setIsLoading(false);
      localStorage.setItem('sijar_user', JSON.stringify({ kodeKelas }));
      navigate('/dashboard');
    }, 1800);
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{
          fontSize: 18, color: COLORS.textMain, fontWeight: 700,
          marginBottom: 10, textAlign: 'center', letterSpacing: '0.01em',
        }}>
          Sistem Inventaris Peminjaman Barang Jurusan
        </p>
        ...
        <div style={{
          ...
          gap: 14, maxWidth: 460, width: '100%',
        }}>
          {features.map((f, i) => (
            <div
              key={i}
              className="feature-tile"
              style={{ animation: `fadeUp 0.7s cubic-bezier(.22,1,.36,1) ${f.delay} both` }}
            >
              <div style={{
      ...
      >
        <div style={{
          ...
          borderRadius: 24, width: '100%', maxWidth: 320,
          boxShadow: `
          ...
          <div className="sijar-badge">
            <div style={{
              ...
              color: COLORS.white, fontSize: 11.5, fontWeight: 800,
          ...
          <div style={{ textAlign: 'center', marginBottom: 18, marginTop: 10 }}>
            <h2 style={{
              fontFamily: "'Plus Jakarta Sans', sans-serif",
              fontSize: 20, fontWeight: 700, color: COLORS.textMain,
          ...
          <div style={{ marginBottom: 10 }}>
            <label style={{
              ...
              marginBottom: 5, color: COLORS.textMain, fontSize: 13, fontWeight: 700,
            }}>
            ...
            <div style={{ position: 'relative' }}>
              <input
                className={`field-input${errors.kode ? ' error' : ''}`}
                type="text"
                value={kodeKelas}
                onChange={(e) => {
                  setKodeKelas(e.target.value);
                  if (errors.kode) setErrors((prev) => ({ ...prev, kode: false }));
                }}
          ...
          <div style={{
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                showToast('ℹ️ Hubungi admin untuk reset password', 'info');
              }}
            >
              Lupa Password?
            </a>
          ...
          <div style={{ textAlign: 'center' }}>
            <p style={{ color: COLORS.textMuted, fontSize: 13, fontWeight: 500 }}>
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  showToast('ℹ️ Hubungi admin untuk registrasi', 'info');
                }}
              >
                Daftar Sekarang
              </a>
